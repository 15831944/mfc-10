...
ULONGLONG CFile64::GetLength( void ) const
{
...
ULONGLONG CFile64::GetPosition( void ) const
{
   WFCLTRACEINIT( TEXT( "CFile64::GetHandle()" ) );
...
void CFile64::LockRange( ULONGLONG position, ULONGLONG number_of_bytes_to_lock )
{
...
ULONGLONG CFile64::Seek( ULONGLONG offset, UINT from )
{
...
void CFile64::SeekToBegin( void )
{
   ...
   Seek( (ULONGLONG) 0, CFile64::begin );
}

ULONGLONG CFile64::SeekToEnd( void )
{
   WFCLTRACEINIT( TEXT( "CFile64::SeekToEnd()" ) );
   return( Seek( (ULONGLONG) 0, CFile64::end ) );
}

BOOL CFile64::SetEndOfFile( ULONGLONG length )
{
...
void CFile64::SetLength( ULONGLONG new_length )
{
...
void CFile64::UnlockRange( ULONGLONG position, ULONGLONG number_of_bytes_to_unlock )
{
