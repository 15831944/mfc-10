...
BOOL CScribbleApp::InitInstance()
{
    ...
    // register the customised document template for the scribble resource
   	pDocTemplate = new CSizeBarDocTemplate(
		IDR_SCRIBBTYPE,
		RUNTIME_CLASS(CScribbleDoc),
		NULL, //RUNTIME_CLASS(CChildFrame), // custom MDI child frame
		RUNTIME_CLASS(CScribbleView));
	AddDocTemplate(pDocTemplate);

    // register the other doctemplate
    pDocTemplate = new CMultiDocTemplate(
		IDR_OTHERTYPE,
		RUNTIME_CLASS(COtherDoc),
