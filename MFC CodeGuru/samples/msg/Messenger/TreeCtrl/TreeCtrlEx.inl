...
CTLEXT_INLINE CTreeCursor::operator HTREEITEM()
	{ return m_hTreeItem; }
CTLEXT_INLINE CTreeCursor::operator !()
	{ return !m_hTreeItem; }
CTLEXT_INLINE CTreeCursor CTreeCursor :: InsertAfter (LPCTSTR strItem,
    HTREEITEM hAfter, int nImageIndex, int nImageSelectedIndex) 
	{ return _Insert (strItem, nImageIndex, nImageSelectedIndex, hAfter); }
CTLEXT_INLINE CTreeCursor CTreeCursor :: AddHead (LPCTSTR strItem, int nImageIndex, int nImageSelectedIndex) 
	{ return _Insert (strItem, nImageIndex, nImageSelectedIndex, TVI_FIRST); }
CTLEXT_INLINE CTreeCursor CTreeCursor :: AddTail (LPCTSTR strItem, int nImageIndex, int nImageSelectedIndex) 
	{ return _Insert (strItem, nImageIndex, nImageSelectedIndex, TVI_LAST); }
