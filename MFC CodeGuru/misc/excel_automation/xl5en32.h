...
/////////////////////////////////////////////////////////////////////////////
// Wrapper-Klasse Application 

class Application : public COleDispatchDriver
{
public:
	Application() {}		// Ruft den Standardkonstruktor für COleDispatchDriver auf
...
public:
	...
	VARIANT Choose();
	VARIANT Clean();
	LPDISPATCH Columns(const VARIANT& Index); // changed by T.B.
	VARIANT Combin();
	VARIANT Confidence();
	...
	LPDISPATCH Workbooks(const VARIANT& Index);	// changed by T.B.
	LPDISPATCH Workbooks();	// new by T.B.
...
/////////////////////////////////////////////////////////////////////////////
// Wrapper-Klasse Workbook 

class Workbook : public COleDispatchDriver
{
public:
	Workbook() {}		// Ruft den Standardkonstruktor für COleDispatchDriver auf
...
public:
	...
	VARIANT Close(const VARIANT& SaveChanges); // new by T.B. , const VARIANT& Filename, const VARIANT& RouteWorkbook);
	...
	VARIANT SaveAs(const VARIANT& Dateiname, const VARIANT& Dateiformat);// new by T.B.
...
public:
	...
	VARIANT OpenText(const VARIANT& Dateiname, const VARIANT& Ursprung, const VARIANT& Startzeile, const VARIANT& Datentyp, const VARIANT& Textkennzeichner, const VARIANT& AufeinanderfolgendeTrennzeichen, const VARIANT& Tab, 
		const VARIANT& Semikolon);	// new by T.B.
...
/////////////////////////////////////////////////////////////////////////////
// Wrapper-Klasse Worksheet 

class Worksheet : public COleDispatchDriver
{
public:
	Worksheet() {}		// Ruft den Standardkonstruktor für COleDispatchDriver auf
