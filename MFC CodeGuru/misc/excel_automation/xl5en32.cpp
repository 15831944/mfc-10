...
LPDISPATCH Application::Columns(const VARIANT& Index)
{	// function changed by T.B.
	LPDISPATCH result;
	static BYTE parms[] =
		VTS_VARIANT;
	InvokeHelper(0xf1, DISPATCH_METHOD, VT_DISPATCH, (void*)&result, parms,
		&Index);
	return result;
}
...
LPDISPATCH Application::Workbooks(const VARIANT& Index)
{
	...
	static BYTE parms[] =
		VTS_VARIANT;
	InvokeHelper(0x23c, DISPATCH_METHOD, VT_DISPATCH, (void*)&result, parms, &Index);
	return result;
}
...
// function new by T.B.
VARIANT Workbook::Close(const VARIANT& SaveChanges)
{
	VARIANT result;
	static BYTE parms[] = VTS_VARIANT;
	InvokeHelper(0x115, DISPATCH_METHOD, VT_VARIANT, (void*)&result, parms,	&SaveChanges);
	return result;
}
...
// function new by T.B.
VARIANT Workbook::SaveAs(const VARIANT& Filename, const VARIANT& Fileformat)
{
	
	VARIANT result;
	static BYTE parms[] = VTS_VARIANT VTS_VARIANT ;
	InvokeHelper(0x11c, DISPATCH_METHOD, VT_VARIANT, (void*)&result, parms,	&Filename, &Fileformat);
	return result;
}
...
// New by T.B.
VARIANT Workbooks::OpenText(const VARIANT& Filename, const VARIANT& Origin, const VARIANT& StartRow, const VARIANT& DataType, const VARIANT& TextQualifier, const VARIANT& ConsecutiveDelimiter, const VARIANT& Tab, 
		const VARIANT& Semikolon ) // const VARIANT& Komma, const VARIANT& Space, const VARIANT& other, const VARIANT& otherchar, const VARIANT& Fieldinfo)	// Text÷ffnen
{
	VARIANT result;
	static BYTE parms[] =
		VTS_VARIANT VTS_VARIANT VTS_VARIANT VTS_VARIANT VTS_VARIANT VTS_VARIANT VTS_VARIANT VTS_VARIANT; // VTS_VARIANT VTS_VARIANT VTS_VARIANT VTS_VARIANT VTS_VARIANT;
	InvokeHelper(0x2ab, DISPATCH_METHOD, VT_VARIANT, (void*)&result, parms, &Filename, 
		&Origin, &StartRow, &DataType, &TextQualifier, &ConsecutiveDelimiter, &Tab, &Semikolon); //, &Komma, &Leerzeichen, &Anderes, &AnderesZeichen, &Feldinfo);
	return result;
}


/////////////////////////////////////////////////////////////////////////////
// Eigenschaften Worksheet 
