...
#if !defined(AFX_HYPERLINK_H_001_000_0041998_ENG_INCLUDED_)
#define AFX_HYPERLINK_H_001_000_0041998_ENG_INCLUDED_

#if _MSC_VER >= 1000
#pragma once
#endif // _MSC_VER >= 1000

#define HLS_UNDERLINE		0x00000001		// No Underline bit
#define HLS_USEHOVER		0x00000002		// Hand over coloring bit
#define HLS_AUTOSIZE		0x00000004		// Auto size bit
#define HLS_DOWNCLICK		0x00000008		// Down click mode bit
#define HLS_GETFOCUSONCLICK	0x00000010		// Get focus on click bit
#define	HLS_NOHANDCURSOR	0x00000020		// No hand cursor bit
#define HLS_NOACTIVECOLOR	0x00000040		// No active color bit
...
#endif // !defined(AFX_HYPERLINK_H_001_000_0041998_ENG_INCLUDED_)
