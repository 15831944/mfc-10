// MIDIGenerator.cpp : Defines the class behaviors for the application.
//
...
BEGIN_MESSAGE_MAP(CMIDIGeneratorApp, CWinApp)
	//{{AFX_MSG_MAP(CMIDIGeneratorApp)
...
/////////////////////////////////////////////////////////////////////////////
// CMIDIGeneratorApp construction

CMIDIGeneratorApp::CMIDIGeneratorApp()
{
...
/////////////////////////////////////////////////////////////////////////////
// The one and only CMIDIGeneratorApp object

CMIDIGeneratorApp theApp;

/////////////////////////////////////////////////////////////////////////////
// CMIDIGeneratorApp initialization

BOOL CMIDIGeneratorApp::InitInstance()
{
	...
	pDocTemplate = new CSingleDocTemplate(
		IDR_MAINFRAME,
		RUNTIME_CLASS(CMIDIGeneratorDoc),
		RUNTIME_CLASS(CMainFrame),       // main SDI frame window
		RUNTIME_CLASS(CMIDIGeneratorView));
...
void CMIDIGeneratorApp::OnAppAbout()
{
	CAboutDlg aboutDlg;
	aboutDlg.DoModal();
}
