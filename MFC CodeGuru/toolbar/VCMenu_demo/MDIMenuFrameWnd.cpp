...
CMDIMenuFrameWnd::CMDIMenuFrameWnd()
{
}
...
IMPLEMENT_DYNAMIC(CMDIMenuFrameWnd, CMDIFrameWnd)

BEGIN_MESSAGE_MAP(CMDIMenuFrameWnd, CMDIFrameWnd)
	//{{AFX_MSG_MAP(CMDIMenuFrameWnd)
	ON_WM_CREATE()
	ON_WM_MENUCHAR()
	ON_WM_ACTIVATE()
	//}}AFX_MSG_MAP
...
/////////////////////////////////////////////////////////////////////////////
// CMDIMenuFrameWnd message handlers

int CMDIMenuFrameWnd::OnCreate(LPCREATESTRUCT lpCreateStruct) 
{
	...
	{
		TRACE0("CMDIMenuFrameWnd: Failed to create menu\n");
		return -1;
	}
...
BOOL CMDIMenuFrameWnd::OnCreateClient(LPCREATESTRUCT lpcs, CCreateContext* pContext) 
{
...
LRESULT CMDIMenuFrameWnd::OnMenuChar(UINT nChar, UINT nFlags, CMenu* pMenu) 
{
...
void CMDIMenuFrameWnd::OnActivate(UINT nState, CWnd* pWndOther, BOOL bMinimized) 
{
...
void CMDIMenuFrameWnd::EnableDocking(DWORD dwDockStyle)
{
...
BOOL CMDIMenuFrameWnd::LoadFrame(UINT nIDResource, DWORD dwDefaultStyle,
