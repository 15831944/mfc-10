////////////////////////////////////////////////////////////////
// 1997 Microsoft Systems Journal. ( originally CCoolMenuManager )
...
namespace MFCXLB // ( originally PxLib )
{
...
//////////////////
// CMFCXMenuMgr implements "cool" menus with buttons in them. To use:
//
...
//
class CLASS_EXPORT CMFCXMenuMgr : private CMFCXSubclassWnd
{
public:
	DECLARE_DYNAMIC(CMFCXMenuMgr)
	CMFCXMenuMgr();
	~CMFCXMenuMgr();
	...
	BOOL Install(CFrameWnd* pFrame);					// connect to main frame
...
protected:
	...
	// window proc to hook frame using CMFCXSubclassWnd implementation
	virtual LRESULT WindowProc(UINT msg, WPARAM wp, LPARAM lp);

	// CMFCXSubclassWnd message handlers 
