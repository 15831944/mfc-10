========================================================================
       MICROSOFT FOUNDATION CLASS LIBRARY : shelldoc
========================================================================


AppWizard has created this shelldoc application for you.  This application
not only demonstrates the basics of using the Microsoft Foundation classes
but is also a starting point for writing your application.

This file contains a summary of what you will find in each of the files that
make up your shelldoc application.

shelldoc.h
    This is the main header file for the application.  It includes other
    project specific headers (including Resource.h) and declares the
    CShelldocApp application class.
...
res\shelldoc.ico
    ...
    icon is included by the main resource file shelldoc.rc.
...
shelldocDlg.h, shelldocDlg.cpp - the dialog
    These files contain your CShelldocDlg class.  This class defines
    the behavior of your application's main dialog.  The dialog's
    template is in shelldoc.rc, which can be edited in Microsoft
	Developer Studio.

DlgProxy.h, DlgProxy.cpp - the automation object
    These files contain your CShelldocDlgAutoProxy class.  This class
...
StdAfx.h, StdAfx.cpp
    ...
    named shelldoc.pch and a precompiled types file named StdAfx.obj.
