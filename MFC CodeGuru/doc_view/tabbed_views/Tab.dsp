...
SOURCE=$(InputPath)
PreLink_Cmds=lib.exe /out:..\..\lib\tab.lib ..\..\temp\tab\tab.obj
...
# Begin Custom Build
IntDir=.\temp
InputPath=.\bin\Tab.exe
SOURCE=$(InputPath)

"..\..\lib\tab.lib" : $(SOURCE) "$(INTDIR)" "$(OUTDIR)"
	lib.exe /out:..\..\lib\tab.lib $(IntDir)\tabwnd.obj
