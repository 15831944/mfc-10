...
class MRCEXT_EXT_CLASS  CMRCSizeDialogBar : public CMRCSizeControlBar
{
...
// as CToolBar.   
class MRCEXT_EXT_CLASS  CMRCSizeToolBar : public CMRCSizeControlBar
{
// Construction
public:
...
protected:
	CSize   m_sizeImage;           // size of bitmap image
	CSize   m_sizeButton;          // size of image
...
// Overrides
	...
	virtual void OnSizedOrDocked(int cx, int cy, BOOL bFloating, int flags);
    LONG OnAddContextMenuItems(WPARAM wParam, LPARAM lParam);
	virtual void OnUpdateCmdUI(CFrameWnd* pTarget, BOOL bDisableIfNoHndler);
...
class MRCEXT_EXT_CLASS  CMRCAnimateCtrl : public CWnd
{
// Construction
public:
	CMRCAnimateCtrl();
...
////////////////////////////////////////////////////////////////////////////////
//
class MRCEXT_EXT_CLASS  CMRCDib : public CObject
//
////////////////////////////////////////////////////////////////////////////////
{
...
public:
    ...
    HBITMAP GetMappedBitmap(const BITMAPCOLORMAP* pColorMap, int nMaps = 4);
...
public:
	int SaveFile(LPCTSTR lpFileName);
	int ColorTableSize();
};
...
class MRCEXT_EXT_CLASS  CMRCDibPal : public CPalette
{
public:
    CMRCDibPal();
    ~CMRCDibPal();
...
class MRCEXT_EXT_CLASS  CMRCColorLabel : public CWnd
{
// Construction
public:
...
public:
	...
	BOOL CreateSplashTimed(LPCTSTR lpszResource, DWORD dwStyle, BOOL bBorder, int nSecs);
...
public:
	...
	afx_msg BOOL OnQueryNewPalette();	// RES need this to be public
...
class MRCEXT_EXT_CLASS CMRCBitmapButton : public CButton
{
...
HBITMAP MRCEXT_EXT_CLASS LoadRecolorBitmap(LPCTSTR lpszResourceName, const BITMAPCOLORMAP * pColorMap = NULL, int nMaps = 0);
HBITMAP MRCEXT_EXT_CLASS LoadRecolorBitmap(UINT nID, const BITMAPCOLORMAP * pColorMap = NULL, int nMaps = 0);
HBITMAP MRCEXT_EXT_CLASS LoadRecolorBitmap(HINSTANCE hInst, HRSRC hRsrc, const BITMAPCOLORMAP * pColorMap = NULL, int nMaps = 0);
