...
OtherDoc.h, OtherDoc.cpp - the document
    These files contain your COtherDoc class.  Edit these files to
    add your special document data and to implement file saving and loading
    (via COtherDoc::Serialize).

OtherView.h, OtherView.cpp - the view of the document
    These files contain your COtherView class.
    COtherView objects are used to view COtherDoc objects.

res\OtherDoc.ico
    This is an icon file, which is used as the icon for MDI child windows
    for the COtherDoc class.  This icon is included by the main
