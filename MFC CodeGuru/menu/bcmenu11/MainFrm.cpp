...
HMENU CMainFrame::NewMenu()
{
  ...
  // Now add the bitmaps to the menu options. The first parameter is the
  // menu option text string. If it's NULL, keep the current text string.
  // The second option is the ID of the menu option to change.
  ...
  m_menubar.ModifyODMenu(NULL,ID_FILE_NEW,IDR_MAINFRAME);
  m_menubar.ModifyODMenu(NULL,ID_FILE_OPEN,IDR_MAINFRAME);
  m_menubar.ModifyODMenu(NULL,ID_FILE_SAVE,IDR_MAINFRAME);
  m_menubar.ModifyODMenu(NULL,ID_EDIT_CUT,IDR_MAINFRAME);
  m_menubar.ModifyODMenu(NULL,ID_EDIT_COPY,IDR_MAINFRAME);
  m_menubar.ModifyODMenu(NULL,ID_EDIT_PASTE,IDR_MAINFRAME);
  ...
  m_menubar.ModifyODMenu(NULL,ID_FILE_PRINT,IDR_MAINFRAME);
  m_menubar.ModifyODMenu(NULL,ID_APP_ABOUT,IDR_MAINFRAME);
