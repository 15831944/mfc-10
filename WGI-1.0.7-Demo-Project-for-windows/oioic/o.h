...
//[redefinition] typedef     SI8         BOOL;              /* 布尔类型，规定此类型数据只能有两个值：TRUE 或 FALSE （见下面 TRUE 和 FALSE 的定义）。*/
...
#define     CMD_RUN                     (AC0 + 9)                /* 运行。*/
#define     AC0_                        (AC0 + 10)               /* <其它AC0行为的起点> */ 
