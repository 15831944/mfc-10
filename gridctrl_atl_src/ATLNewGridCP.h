#ifndef _ATLNEWGRIDCP_H_
#define _ATLNEWGRIDCP_H_
...
public:
	HRESULT Fire_BeforeEdit(INT Row, INT Col, VARIANT_BOOL * Cancel)
	{
	...
	HRESULT Fire_ValidateEdit(INT Row, INT Col, VARIANT_BOOL * Cancel)
	{
		CComVariant varResult = VT_EMPTY;
		T* pT = static_cast<T*>(this);
		int nConnectionIndex;
	...
	HRESULT Fire_AfterEdit(INT Row, INT Col)
	{
		CComVariant varResult = VT_EMPTY;
		T* pT = static_cast<T*>(this);
		int nConnectionIndex;
	...
	HRESULT Fire_EnterCell(INT Row, INT Col)
	{
		CComVariant varResult = VT_EMPTY;
		T* pT = static_cast<T*>(this);
		int nConnectionIndex;
	...
	HRESULT Fire_LeaveCell(INT Row, INT Col)
	{
		CComVariant varResult = VT_EMPTY;
		T* pT = static_cast<T*>(this);
		int nConnectionIndex;
	...
	HRESULT Fire_ColumnClick(INT Col)
	{
		CComVariant varResult = VT_EMPTY;
		T* pT = static_cast<T*>(this);
		int nConnectionIndex;
