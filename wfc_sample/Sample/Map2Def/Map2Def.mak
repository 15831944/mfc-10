...
!MESSAGE No configuration specified.  Defaulting to Map2Def - Win32 Debug.
!ENDIF 

!IF "$(CFG)" != "Map2Def - Win32 Release" && "$(CFG)" !=\
 "Map2Def - Win32 Debug"
...
!MESSAGE 
!MESSAGE "Map2Def - Win32 Release" (based on "Win32 (x86) Console Application")
!MESSAGE "Map2Def - Win32 Debug" (based on "Win32 (x86) Console Application")
!MESSAGE 
...
CPP_PROJ=/nologo /MT /W4 /GX /O2 /D "WIN32" /D "NDEBUG" /D "_CONSOLE" /D\
 "_MBCS" /Fp"$(INTDIR)/Map2Def.pch" /YX /Fo"$(INTDIR)/" /c 
CPP_OBJS=.\Release/
CPP_SBRS=.\.
...
LINK32_FLAGS=/nologo /subsystem:console /incremental:no\
 /pdb:"$(OUTDIR)/Map2Def.pdb" /machine:I386 /out:"$(OUTDIR)/Map2Def.exe" 
LINK32_OBJS= \
	"$(INTDIR)\Map2Def.obj"
...
CPP_PROJ=/nologo /MTd /W4 /Gm /GX /Zi /Od /D "WIN32" /D "_DEBUG" /D "_CONSOLE"\
 /D "_MBCS" /Fp"$(INTDIR)/Map2Def.pch" /YX /Fo"$(INTDIR)/" /Fd"$(INTDIR)/" /c 
CPP_OBJS=.\Debug/
CPP_SBRS=.\.
...
LINK32_FLAGS=/nologo /subsystem:console /incremental:yes\
 /pdb:"$(OUTDIR)/Map2Def.pdb" /debug /machine:I386 /out:"$(OUTDIR)/Map2Def.exe" 
LINK32_OBJS= \
	"$(INTDIR)\Map2Def.obj"
...
# Name "Map2Def - Win32 Release"
# Name "Map2Def - Win32 Debug"
...
"$(INTDIR)\Map2Def.obj" : $(SOURCE) "$(INTDIR)"
