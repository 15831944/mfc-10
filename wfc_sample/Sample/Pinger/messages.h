...
//
// MessageId: MSG_PINGER_SUCCESSFULLY_INSTALLED
//
// MessageText:
//
//  Pingersuccessfully installed by %1.
//
#define MSG_PINGER_SUCCESSFULLY_INSTALLED ((DWORD)0x40000001L)

//
// MessageId: MSG_PINGER_SUCCESSFULLY_REMOVED
//
// MessageText:
//
//  Pinger successfully removed by %1.
//
#define MSG_PINGER_SUCCESSFULLY_REMOVED  ((DWORD)0x40000002L)

//
// MessageId: MSG_PINGER_ERROR_CODE
//
// MessageText:
//
//  Error %1, %2
//
#define MSG_PINGER_ERROR_CODE            ((DWORD)0xC0000003L)

//
// MessageId: MSG_PINGER_SERVICE_STARTED
//
// MessageText:
//
//  Service started.
//
#define MSG_PINGER_SERVICE_STARTED       ((DWORD)0x40000004L)

//
// MessageId: MSG_PINGER_SERVICE_STOPPED
//
// MessageText:
//
//  Service stopped
//
#define MSG_PINGER_SERVICE_STOPPED       ((DWORD)0x40000005L)

//
// MessageId: MSG_PINGER_UNEXPECTED_ERROR
//
// MessageText:
//
//  Unexpected error at line %1 of %2, %3
//
#define MSG_PINGER_UNEXPECTED_ERROR      ((DWORD)0xC0000006L)

//
// MessageId: MSG_PINGER_RESTARTING_SERVICE
//
// MessageText:
//
//  Restarting service "%1"
//
#define MSG_PINGER_RESTARTING_SERVICE    ((DWORD)0x40000007L)
...
//
// MessageId: MSG_CANT_CREATE_TIMER_THREAD
//
// MessageText:
//
//  Can't create the timer thread, CreateThread() failed with %1
//
#define MSG_CANT_CREATE_TIMER_THREAD     ((DWORD)0xC000000CL)

//
// MessageId: MSG_CANT_CREATE_TIMER_EVENT
//
// MessageText:
//
//  Can't create the timer event, CreateEvent() failed with %1
//
#define MSG_CANT_CREATE_TIMER_EVENT      ((DWORD)0xC000000DL)
