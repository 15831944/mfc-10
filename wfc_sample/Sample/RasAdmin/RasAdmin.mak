...
!IF "$(CFG)" == ""
CFG=RasAdmin - Win32 Debug
!MESSAGE No configuration specified.  Defaulting to RasAdmin - Win32 Debug.
!ENDIF 

!IF "$(CFG)" != "RasAdmin - Win32 Release" && "$(CFG)" !=\
 "RasAdmin - Win32 Debug"
!MESSAGE Invalid configuration "$(CFG)" specified.
!MESSAGE You can specify a configuration when running NMAKE on this makefile
!MESSAGE by defining the macro CFG on the command line.  For example:
!MESSAGE 
!MESSAGE NMAKE /f "RasAdmin.mak" CFG="RasAdmin - Win32 Debug"
!MESSAGE 
!MESSAGE Possible choices for configuration are:
!MESSAGE 
!MESSAGE "RasAdmin - Win32 Release" (based on\
 "Win32 (x86) Console Application")
!MESSAGE "RasAdmin - Win32 Debug" (based on "Win32 (x86) Console Application")
!MESSAGE 
...
################################################################################
# Begin Project
# PROP Target_Last_Scanned "RasAdmin - Win32 Debug"
CPP=cl.exe
RSC=rc.exe

!IF  "$(CFG)" == "RasAdmin - Win32 Release"
...
ALL : "$(OUTDIR)\RasAdmin.exe"

CLEAN : 
	-@erase "$(INTDIR)\RasAdmin.obj"
	-@erase "$(OUTDIR)\RasAdmin.exe"
...
CPP_PROJ=/nologo /MD /W4 /GX /O2 /I "\wfc\include" /D "WIN32" /D "NDEBUG" /D\
 "_CONSOLE" /D "_AFXDLL" /D "_MBCS" /Fp"$(INTDIR)/RasAdmin.pch" /YX\
 /Fo"$(INTDIR)/" /c 
CPP_OBJS=.\Release/
CPP_SBRS=.\.
...
# ADD BSC32 /nologo
BSC32_FLAGS=/nologo /o"$(OUTDIR)/RasAdmin.bsc" 
BSC32_SBRS= \
	
LINK32=link.exe
# ADD BASE LINK32 kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib odbc32.lib odbccp32.lib /nologo /subsystem:console /machine:I386
# ADD LINK32 netapi32.lib rassapi.lib /nologo /subsystem:console /machine:I386
LINK32_FLAGS=netapi32.lib rassapi.lib /nologo /subsystem:console\
 /incremental:no /pdb:"$(OUTDIR)/RasAdmin.pdb" /machine:I386\
 /out:"$(OUTDIR)/RasAdmin.exe" 
LINK32_OBJS= \
	"$(INTDIR)\RasAdmin.obj"

"$(OUTDIR)\RasAdmin.exe" : "$(OUTDIR)" $(DEF_FILE) $(LINK32_OBJS)
    $(LINK32) @<<
  $(LINK32_FLAGS) $(LINK32_OBJS)
<<

!ELSEIF  "$(CFG)" == "RasAdmin - Win32 Debug"
...
CLEAN : 
	...
	-@erase "$(OUTDIR)\RasAdmin.exe"
	-@erase "$(OUTDIR)\RasAdmin.ilk"
	-@erase "$(OUTDIR)\RasAdmin.pdb"
...
CPP_PROJ=/nologo /MDd /W4 /Gm /GX /Zi /Od /I "\wfc\include" /D "WIN32" /D\
 "_DEBUG" /D "_CONSOLE" /D "_AFXDLL" /D "_MBCS" /Fp"$(INTDIR)/RasAdmin.pch" /YX\
...
# ADD LINK32 \wfc\lib\Windebug\wfc.lib netapi32.lib rassapi.lib /nologo /subsystem:console /debug /machine:I386
LINK32_FLAGS=\wfc\lib\Windebug\wfc.lib netapi32.lib rassapi.lib /nologo\
 /subsystem:console /incremental:yes /pdb:"$(OUTDIR)/RasAdmin.pdb" /debug\
 /machine:I386 /out:"$(OUTDIR)/RasAdmin.exe" 
LINK32_OBJS= \
	"$(INTDIR)\RasAdmin.obj"
...
# Name "RasAdmin - Win32 Release"
# Name "RasAdmin - Win32 Debug"
...
"$(INTDIR)\RasAdmin.obj" : $(SOURCE) $(DEP_CPP_RASAD) "$(INTDIR)"
