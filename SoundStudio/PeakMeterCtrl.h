...
public:
	...
	void SetMeterStyle(int meterStyle);
...
private:
	static void CALLBACK PeakTimerProc(UINT uID, UINT uMsg, DWORD_PTR dwUser, DWORD dw1, DWORD dw2);
