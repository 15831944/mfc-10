...
ResourceCount=8
Resource1=IDD_TRANSPARENT (Neutral)
Resource2=IDD_ADVANCED (Neutral)
Resource3=IDD_BASIC (Neutral)
Resource4=IDD_SHADED (Neutral)
Resource5=IDD_ABOUT (Neutral)
Resource6=IDR_MENU (Neutral)
Resource7=IDD_CBUTTONST_DEMO_DIALOG (Neutral)
