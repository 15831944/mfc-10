// CatalogDlg.h : Declaration of the CCatalogDlg
...
class CCatalogDlg : 
	public CDialogImpl<CCatalogDlg>
{
public:
	CCatalogDlg( )
	{
    ...
    enum { IDD = IDD_NEWCATALOGDLG };
    LPCTSTR GetName(){return mstrName;}

private:
    ATL::CString mstrName;
BEGIN_MSG_MAP(CCatalogDlg)
...
//  LRESULT NotifyHandler(int idCtrl, LPNMHDR pnmh, BOOL& bHandled);
	...
	{
		//CDialogImpl<CCatalogDlg>::OnInitDialog(uMsg, wParam, lParam, bHandled);
        ...
        //mName.SubclassWindow(GetDlgItem(IDC_EDIT_NAME));
