...
class ATL_NO_VTABLE CImageLayer :
	...
	public IDispatchImpl<IImageLayer, &IID_IImageLayer, &LIBID_SceneCOMLib, /*wMajor =*/ 1, /*wMinor =*/ 0>
{
public:
	CImageLayer()
	{
...
END_COM_MAP()
    ...
    void Attach(osgEarth::ImageLayer* pLayer)
	{
		mLayer = pLayer;
	}
	osgEarth::ImageLayer* GetLayer()
	{
		return mLayer;
	}
private:
    osgEarth::ImageLayer* mLayer;
public:
