...
################################################################################
# Begin Project
# PROP Target_Last_Scanned "CDB - Win32 Debug"
CPP=cl.exe
RSC=rc.exe
MTL=mktyplib.exe
...
CLEAN : 
	...
	-@erase "$(INTDIR)\CusFDlg.obj"
	-@erase "$(INTDIR)\DumDlg.obj"
	-@erase "$(INTDIR)\FileDlg.obj"
	-@erase "$(INTDIR)\FontDlg.obj"
...
"$(INTDIR)\CusFDlg.obj" : $(SOURCE) $(DEP_CPP_CUSFD) "$(INTDIR)"\
 "$(INTDIR)\Cdb.pch"
...
"$(INTDIR)\DumDlg.obj" : $(SOURCE) $(DEP_CPP_DUMDL) "$(INTDIR)"\
 "$(INTDIR)\Cdb.pch"
...
"$(INTDIR)\FileDlg.obj" : $(SOURCE) $(DEP_CPP_FILED) "$(INTDIR)"\
 "$(INTDIR)\Cdb.pch"
...
"$(INTDIR)\ColorDlg.obj" : $(SOURCE) $(DEP_CPP_COLOR) "$(INTDIR)"\
 "$(INTDIR)\Cdb.pch"
