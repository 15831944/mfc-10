...
//
// d:\vc++\atl internals 2e src\chapter 05\mathservice\cocalc.mrg.h
...
#injected_line 23 "d:\\vc++\\atl internals 2e src\\chapter 05\\mathservice\\cocalc.h"
...
#injected_line 23 "d:\\vc++\\atl internals 2e src\\chapter 05\\mathservice\\cocalc.h"
    static RGSStrings* GetOpcodeStringVals() 
    {
        static RGSStrings rgStrings[] = 
            					{
            						{_T(""),0 }, 
            {_T("MathService.Calc.1"),0 }, 
            {_T("%FriendlyName%"),1 }, 
            {_T("CLSID"),0 }, 
            {_T("{6D45D859-615D-449B-A06C-355D905AF2FE}"),0 }, 
            {_T("MathService.Calc"),0 }, 
            {_T("CurVer"),0 }, 
            {_T("ProgID"),0 }, 
...
#injected_line 23 "d:\\vc++\\atl internals 2e src\\chapter 05\\mathservice\\cocalc.h"
    ...
    {
        return _T("MathService.Calc.1");
    }
#injected_line 23 "d:\\vc++\\atl internals 2e src\\chapter 05\\mathservice\\cocalc.h"
    static const TCHAR* GetVersionIndependentProgID() 
    {
        return _T("MathService.Calc");
    }
#injected_line 23 "d:\\vc++\\atl internals 2e src\\chapter 05\\mathservice\\cocalc.h"
    BEGIN_COM_MAP(CCalc)
