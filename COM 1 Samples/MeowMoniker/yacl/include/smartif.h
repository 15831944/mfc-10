...
// CoCreateInstance wrappers    
    ...
    {
        Detach();
        COSERVERINFO csi = { 0, const_cast<OLECHAR*>(pwszHostName), pai, 0 };
...
#define RelItfRef() GetReleasedInterfaceReference()
#define ItfRef() GetNonReleasedInterfaceReference()
#define ARItf() GetAddRefedInterface()
#define Itf() GetNonAddRefedInterface()
