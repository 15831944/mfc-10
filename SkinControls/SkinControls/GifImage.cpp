...
void CGIFImage::SetFrameIndex(INT_PTR nFrameIndex)
{
	// 调整图帧
	if (nFrameIndex < 0 || nFrameIndex >= m_GIFFrameInfoArray.GetCount()) m_nCurrentFrame = 0;
	else m_nCurrentFrame = nFrameIndex;
}
