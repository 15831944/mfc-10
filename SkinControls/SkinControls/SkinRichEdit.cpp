...
void CSkinRichEdit::OnRButtonDown(UINT nFlags, CPoint Point)
{
	...
	// 建立菜单
	FunctionMenu.AppendMenu(0, IDM_COPY_STRING, TEXT("复制"));
	FunctionMenu.AppendMenu(0, IDM_SELECT_ALL, TEXT("全选"));
	FunctionMenu.AppendMenu(0, IDM_DELETE_STRING, TEXT("删除"));
	FunctionMenu.AppendMenu(0, IDM_CLEAR_ALL, TEXT("清除屏幕"));
	//FunctionMenu.AppendSeparator();
	//FunctionMenu.AppendMenu(0, IDM_SAVE_STRING, TEXT("保存信息..."));
