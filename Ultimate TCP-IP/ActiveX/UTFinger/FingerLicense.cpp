//=================================================================
//  class: CFingerLicense
//  File:  FingerLicense.cpp
//
//  Finger ActiveX control license support
//
//=================================================================
...
Return
	...
	FALSE	- if not
****************************************************/
BOOL CFingerLicense::VerifyLicenseKey(BSTR bstr)   
{
	USES_CONVERSION;
...
Return
	TRUE		- success
****************************************************/
BOOL CFingerLicense::GetLicenseKey(DWORD dwReserved, BSTR* pBstr) 
{  
	USES_CONVERSION;
...
Return
	...
	FALSE	- if not
****************************************************/
BOOL CFingerLicense::IsLicenseValid() 
{
	USES_CONVERSION;
	...
	if( ! m_bLicense ) {
		CAboutDlg	dlg("Can't create Finger Control! License key is missing."); 
		dlg.DoModal();
		}
