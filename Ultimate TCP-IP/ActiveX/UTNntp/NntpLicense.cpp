//=================================================================
//  class: CNntpLicense
//  File:  NntpLicense.cpp
//
//  NNTP ActiveX control license support
//
//=================================================================
...
Return
	...
	FALSE	- if not
****************************************************/
BOOL CNntpLicense::VerifyLicenseKey(BSTR bstr)   
{
	USES_CONVERSION;
...
Return
	TRUE		- success
****************************************************/
BOOL CNntpLicense::GetLicenseKey(DWORD dwReserved, BSTR* pBstr) 
{  
	USES_CONVERSION;
...
Return
	...
	FALSE	- if not
****************************************************/
BOOL CNntpLicense::IsLicenseValid() 
{
	USES_CONVERSION;
	...
	if( ! m_bLicense ) {
		CAboutDlg	dlg(_T("Can't create Nntp Control! License key is missing.")); 
		dlg.DoModal();
		}
