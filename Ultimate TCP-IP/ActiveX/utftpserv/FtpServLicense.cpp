//=================================================================
//  class: CFtpServLicense
//  File:  FtpServLicense.cpp
//
...
Return
	none
****************************************************/
CFtpServLicense::CFtpServLicense() 
{
}
...
Return
	...
	FALSE	- if not
****************************************************/
BOOL CFtpServLicense::VerifyLicenseKey(BSTR bstr)   
{
	USES_CONVERSION;
...
Return
	TRUE		- success
****************************************************/
BOOL CFtpServLicense::GetLicenseKey(DWORD dwReserved, BSTR* pBstr) 
{  
	USES_CONVERSION;
...
Return
	...
	FALSE	- if not
****************************************************/
BOOL CFtpServLicense::IsLicenseValid() 
{
	USES_CONVERSION;
	...
	if( ! m_bLicense ) {
		CAboutDlg	dlg("Can't create FtpServer Control! License key is missing."); 
		dlg.DoModal();
		}
