...
//  Purpose:
//
//	Display Mail ActiveX Control about box
//
// =================================================================
...
//  LRESULT NotifyHandler(int idCtrl, LPNMHDR pnmh, BOOL& bHandled);
	...
	LRESULT OnInitDialog(UINT uMsg, WPARAM wParam, LPARAM lParam, BOOL& bHandled)
	{
			...
			// Change about box text in case of blocking mode only
			char	szVersionText[50], szEvaluationVersionText[50];
			GetDlgItemText(IDC_VERSION_TEXT, szVersionText, sizeof(szVersionText) - 1);
			
			strcpy(szEvaluationVersionText, szVersionText);
			strcat(szEvaluationVersionText, " (Blocking Mode Only)");
