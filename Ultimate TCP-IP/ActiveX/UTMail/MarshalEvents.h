...
//
//  ActiveX control event sink marshalling
//
//=================================================================
...
public:
	...
	****************************************************/
	CMarshalEvents() :	m_ptrInterfaces(NULL),	// Initialize interface list
						m_bUseMarshaling(TRUE)	// Initialize marshaling flag
	{ 
	}
	...
	****************************************************/
	IDispatch *GetMarshaledInterface(IDispatch *ptrIDispatch)
	{
		...
		// If we don't use marshaling - return original IDispatch
		if(!m_bUseMarshaling)
			return ptrIDispatch;
...
protected:
	...
	BOOL				m_bUseMarshaling;	// TRUE if we are using marshaling
