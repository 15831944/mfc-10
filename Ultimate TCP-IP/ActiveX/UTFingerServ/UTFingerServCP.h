#ifndef _UTFINGERSERVCP_H_
#define _UTFINGERSERVCP_H_



template <class T>
class CProxy_IFingerServEvents : public IConnectionPointImpl<T, &DIID__IFingerServEvents, CComDynamicUnkArray>
{
