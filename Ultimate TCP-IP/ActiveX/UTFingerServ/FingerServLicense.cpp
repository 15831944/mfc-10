//=================================================================
//  class: CFingerServLicense
//  File:  FingerLicense.cpp
//
...
Return
	none
****************************************************/
CFingerServLicense::CFingerServLicense() 
{
}
...
Return
	...
	FALSE	- if not
****************************************************/
BOOL CFingerServLicense::VerifyLicenseKey(BSTR bstr)   
{
	USES_CONVERSION;
...
Return
	TRUE		- success
****************************************************/
BOOL CFingerServLicense::GetLicenseKey(DWORD dwReserved, BSTR* pBstr) 
{  
	USES_CONVERSION;
...
Return
	...
	FALSE	- if not
****************************************************/
BOOL CFingerServLicense::IsLicenseValid() 
{
	USES_CONVERSION;
	...
	if( ! m_bLicenseChecked ) {					
	   ...
	   strcat(szLicenseFile, _T("\\datas.lic"));
	...
	if( ! m_bLicense ) {
		CAboutDlg	dlg("Can't create FingerServer Control! License key is missing."); 
		dlg.DoModal();
		}
